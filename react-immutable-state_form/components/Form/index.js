...
export default function Form() {
  ...
  function handleNameChange(event) {
    // setMountain((previousMountain) => {
    //   return {
    //     ...previousMountain, name: event.target.value
    //   }
    // })
  ...
  function handleAltitudeChange(event) {
    // setMountain((previousMountain) => {
    //   return {
    //     ...previousMountain, values: { ...previousMountain.values, altitude: event.target.value }
    //   }
    // })
    updateMountain(draft => {
  ...
  function handleMountainRangeChange(event) {
    // setMountain((previousMountain) => {
    //   return {
    //     ...previousMountain, values: { ...previousMountain.values, mountainRange: event.target.value }
    //   }
    // })
    updateMountain(draft => {
