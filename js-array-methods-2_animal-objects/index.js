...
const animalsSortedByWeightStartingWithLowest = animals.slice().sort((animalA, animalB) => animalA.weight - animalB.weight);

const animalsSortedByWeightReversed = animals.slice().sort((animalA, animalB) => animalA.weight - animalB.weight).reverse();
