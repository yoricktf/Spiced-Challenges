...
const displayBox = document.querySelector("[data-js=box]")
let colorSlider = document.querySelector("[data-js=input-color]")
let radiusSlider = document.querySelector("[data-js=input-radius]")
let rotationSlider = document.querySelector("[data-js=input-rotation]")

colorSlider.addEventListener('input', () => {
  displayBox.style.background = `hsl(${colorSlider.value}, 70%, 60%)`
})

radiusSlider.addEventListener('input', () => {
  displayBox.style.borderRadius = `${radiusSlider.value}%`
})

rotationSlider.addEventListener('input', () => {
  displayBox.style.transform = `rotate(${rotationSlider.value}deg)`
})
